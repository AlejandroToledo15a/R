...
delitos <- read_xlsx('D:/Documentos/Alejandro Ciencia de Datos/Seminario de Estadística/Tareas/Semana 2/carpetas-de-investigacion-pgj-de-la-ciudad-de-mexico.xlsx')
View(delitos)
